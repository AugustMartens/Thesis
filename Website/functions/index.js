...
app.get('/home', function(req, res, next) {
    ...
    const decoded = jwt.verify(req.cookies.accessCookie.t, process.env.ACCESS_TOKEN_SECRET);
		console.log("environment variable:" + process.env.ACCESS_TOKEN_SECRET);
		console.log(decoded);
     return next();
  } catch (error) {
    //res.status(401);
...
passport.use(new FacebookStrategy({
  clientID: '543447053188431',
  clientSecret: '16279608dc9817a551e000e9658bb14b',
  callbackURL: 'https://thesis-c30c3.firebaseapp.com/auth/facebook/callback'
},
...
passport.use('google', new GoogleStrategy({
  clientID: '478215553211-tfnbn490haltalfu0f5mj9ia562npjnq.apps.googleusercontent.com',
  clientSecret: 'rZN-CYVTqSulxGz1hzyO6Mch',
  callbackURL: 'https://thesis-c30c3.firebaseapp.com/auth/google/callback',
	passReqToCallback: true
},
async function(request, accessToken, refreshToken, profile, done) {
  try {
		await db_scripts.db_insertion_google('final.demo@gmail.com', accessToken, refreshToken, profile.id);
		done(null);
	} catch(e) {
		done(e);
	}
...
passport.use('google-calendar', new GoogleStrategy({
  clientID: '478215553211-tfnbn490haltalfu0f5mj9ia562npjnq.apps.googleusercontent.com',
  clientSecret: 'rZN-CYVTqSulxGz1hzyO6Mch',
  callbackURL: 'https://thesis-c30c3.firebaseapp.com/auth/google/callbackcalendar',
	passReqToCallback: true
},
async function(request, accessToken, refreshToken, profile, done) {
  try {
		await db_scripts.db_insertion_google_calendar('final.demo@gmail.com', accessToken, refreshToken, profile.id);
		done(null);
	} catch(e) {
		done(e);
	}
...
app.get('/auth/googlecalendar', passport.authenticate('google-calendar', {
...
app.get('/auth/google/callbackcalendar',
  passport.authenticate('google-calendar', { succesRedirect: '/home',
                                      failureRedirect: '/'}));
